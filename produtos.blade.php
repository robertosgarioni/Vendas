...
<script type="text/javascript">
    ...
    function montarLinha(p) {
        var linha = "<tr>" +
            ...
            "<td>" + p.datacriacao_id + "</td>" +
            "<td>" + p.dataalteracao_id + "</td>" +
            "<td>" +
    ...
    function editar(id) {
        $.getJSON('/api/produtos/'+id, function(data) { 
            ...
            $('#datacriacao').val(data.datacriacao_id);
            $('#dataalteracao').val(data.dataaltercao_id);
            $('#dlgProdutos').modal('show');            
        });        
    }
    ...
    function salvarProduto() {
        prod = { 
            ...
            dataalteracao: $("#dataalterecao").val(),
            categoria_id: $("#categoriaProduto").val() 
        };
        $.ajax({
            type: "PUT",
            ...
            success: function(data) {
                ...
                if (e) {
                    ...
                    e[0].cells[5].textContent = prod.datacriacao_id;
                    e[0].cells[6].textContent = prod.dataalteracao_id;
                }
            },
            error: function(error) {
                console.log(error);
